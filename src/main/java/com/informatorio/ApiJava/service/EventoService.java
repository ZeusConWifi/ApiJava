...
public class EventoService {
    ...
    public void actualizarEstado(Evento evento, LocalDate ahora) {
        if (evento.getFechaCierre().isBefore(ahora)) { evento.setEstado(Estado.EN_CURSO); }
