...
public class Emprendimiento {
    ...
    @NotEmpty(message = "El campo Descripcion no deberia estar vacio")
    private String descripcion;
    @NotEmpty(message = "El campo Contenido no deberia estar vacio")
    ...
    public String toString() {
        return "Emprendimiento [activo=" + activo + ", contadorVotos=" + contadorVotos + ", contenido=" + contenido
                + ", creador=" + creador + ", descripcion=" + descripcion + ", eventos=" + eventos
                + ", fechaCreacion=" + fechaCreacion + ", id=" + id + ", nombre=" + nombre + ", objetivo="
