...
public class EventoService {
    ...
    public void actualizarEstado(Evento evento, LocalDate ahora) {
        if (evento.getFechaDeInicio().isBefore(ahora)) { evento.setEstado(Estado.EN_CURSO); }
    ...
    public Emprendimieto registrar(Long emprendimientoId, Long eventoId, EventoDTO eventoDTO) {
        Emprendimieto emprendimientoRegistrado = emprendimientoRepository.getById(emprendimientoId);
